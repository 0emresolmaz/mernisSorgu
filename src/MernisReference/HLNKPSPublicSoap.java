...
public class HLNKPSPublicSoap
{
    ...
    public HLNKPSPublicSoap(){}

    public HLNKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public HLNKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        HLNExtendedSoapSerializationEnvelope envelope= new HLNExtendedSoapSerializationEnvelope(HLNExtendedSoapSerializationEnvelope.VER11);
