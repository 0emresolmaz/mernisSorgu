...
public class HLNExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(HLNDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new HLNStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static HLNDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static HLNDateTimeConverter dateTimeConverter = new HLNStandardDateTimeConverter();

    public HLNExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public HLNExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new HLNMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=HLNHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,HLNExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=HLNHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
